...
const ITEMS = [
  {
    q: 'هل قاضي اراك منصة عامة أو منتج للبيع؟',
    a: 'لا. قاضي اراك منصة داخلية مستقلة خُصصت لتنظيم أعمال الشؤون القانونية في مجموعة اراك للتنمية، وتُبنى وظائفها وصلاحياتها ومساراتها حول احتياجات المجموعة وفرقها.',
  },
  {
    ...
    <Section id="faq" className="py-20 sm:py-28">
      <div className="reveal mx-auto max-w-3xl text-center">
        ...
        <h2 className="mt-5 font-display text-3xl font-extrabold leading-snug text-white sm:text-4xl">
          ما الذي يقدمه قاضي اراك؟ ومن يملك القرار داخله؟
        </h2>
